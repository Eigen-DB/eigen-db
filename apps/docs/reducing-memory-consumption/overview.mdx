...
In memory, a single 1536-dimensional vector is represented as a list of 1536 float32 values. Meaning that a single vector consumes $$$\frac{1536 * 32}{8} = 6144 \text{ bytes} = 6 \text{ kilobytes}$$$. 

Now let's assume you have 1,000,000 vectors in your database. The total memory consumption would be: $$$6 * 10^6 = 6,000,000 \text{ kilobytes} \approx 5.72 \text{ gigabytes}$$$. 
